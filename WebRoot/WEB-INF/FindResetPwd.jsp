...
<body>
			...
			<div class="nav-1">
				<div class="mod-nav reset clearfix animate-enter">
					<ul class="nav-list clearfix">
						<!-- <li class="list-item list-item-ucenter">
							<a class="page-tab" >
							<span>帐号设置</span></a>
						</li> -->
	...
	<div id="content">
		<div class="mod-bread-nav">
			<a class="nav-bread nav-bread-sub " >密码管理</a> 
			<em class="nav-gt">&gt;</em>
			<a class="nav-bread nav-bread-sub nav-bread-nolink">重置密码</a>
		</div>
		<div class="mod-reset">
			<div class="mod-step-detail">
				<form action="FindRePwdServlet" method="post" id="form-findresetpwd">
					...
					<div class="m_l80">
						<a href="#" >
					    	<input type="image" src="img/confirm1.jpg" onclick="find_update_pwd();">
