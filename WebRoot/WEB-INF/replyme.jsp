			...
			<li class="u_ucenter">
				<div>
					<span class="u_arrow u_menu_title"><a
						href="LoginServlet?loginemail=${ui.userEmail}">个人中心</a></span>
				</div>
						...
						<div id="main_header_logo" class="main_header">
							<ul class="nav_bar">
								...
								<li class="nav_item"><a href="mainview.jsp"
									onMouseDown="$.stats.hive('tb_index')" target="_self">贴吧首页</a>
								</li>
								<li class="nav_cur"><a
									href="LoginServlet?loginemail=${ui.userEmail}" target="_self">我的贴吧</a>
								</li>
							</ul>
						</div>
							...
							<div class="w750 fleft">
								<div id="content">
									...
									<ul id="tab" class="tab_content">
										...
										<!-- <li class="tab ">
										<a href="atme.jsp"  target="_self">@提到我的</a>
										</li> -->
										<li class="tab "><a href="store.jsp" target="_self">收藏的贴子</a>
										</li>
									</ul>
								...
								<div id="aside_menu" class="aside_menu">
									<ul>
										<li class="aside_home_li"><a id="aside_home"
											href="mainview.jsp">首页</a></li>
										<li class="aside_mytie_li"><a id="aside_mytie" href="#">我的帖子</a>
										</li>
